...
describe("auro-toast", () => {
  ...
  describe("handles styling correctly", () => {
    ...
    describe("when type is ", () => {
      ...
      it("not specified", async () => {
        ...
        await expect(toastIcon.innerHTML).to.contain("Checkmark display indicator");
      });
    ...
    describe("when position is ", () => {
      ...
      it("invalid", async () => {
        const el = await fixture(html`<auro-toast position="absolute"></auro-toast>`);
        const root = el.shadowRoot;
        const toast = root.querySelector("#toast")
      ...
      it("left", async () => {
        const el = await fixture(html`<auro-toast position="left"></auro-toast>`);
        const root = el.shadowRoot;
        const toast = root.querySelector("#toast")
      ...
      it("right", async () => {
        const el = await fixture(html`<auro-toast position="right"></auro-toast>`);
        const root = el.shadowRoot;
        const toast = root.querySelector("#toast")
  ...
  describe('handles dismissal', () => {
    ...
    it('from attribute', async () => {
      const el = await fixture(html`<div><auro-toast dismiss></auro-toast></div>`);
    ...
    it('from timeout', async () => {
      const el = await fixture(html`<div><auro-toast duration="1"></auro-toast></div>`);
      const root = el.querySelector("auro-toast").shadowRoot;
      const toast = root.querySelector("#toast");
    ...
    it('when persistent', async () => {
      const el = await fixture(html`<div><auro-toast duration="1" persistent></auro-toast></div>`);
      const root = el.querySelector("auro-toast").shadowRoot;
      const toast = root.querySelector("#toast");
